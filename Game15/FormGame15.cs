...
namespace Game15
{
    public partial class FormGame15 : Form
    {
        ...
        {
            MessageBox.Show("Игра пятнашки заключается в том, чтобы поставить все цифры по порядку в порядке возрастания");
        }

        private void оРазработчикеToolStripMenuItem_Click(object sender, EventArgs e)
        {
            MessageBox.Show("Игру пятнашки сделала студентка 3 курса Бугульминского машиностроительного техникума" +
                "Давлетбаева Аделина Сириновна");
        }
    }
}
